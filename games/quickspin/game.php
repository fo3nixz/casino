...
<?
    ...
    if($api->getGameStringId() == 'firestorm' || $api->getGameStringId() == 'sinbad') {
        $langLink = $game;
    }
	...
	$game_swf = $sh. 'GTSWrapper.swf?brand=vanilla&theGame='.$sh.$game.'.swf&lang='.$langLink.'_'.$lang.'.xml&edgeServlet='.$serverLink.'&width=100%25&height=100%25&vssession=&loginScript=loadLobby()&play4=free&domain=harrycasino.com&nativeHeight=700&nativeWidth=1130&gameTitle='.$game;
